return {
  {
    ...
    opts = {
      ...
      -- },
      templates = { "shell", "user.overseer_run_python", "user.overseer_run_python_with_args", "builtin" },
      default_detail = 3,
      task_list = {
        -- direction = "right",
        bindings = {
    ...
    keys = function(_, keys)
      local new_keys = {
        ...
        -- { "<leader>os", "<cmd>OverseerQuickAction stop<cr>", desc = "Stop" },
        ...
        { "<leader>of", "<cmd>OverseerTaskAction<cr>", desc = "Select task action" },
